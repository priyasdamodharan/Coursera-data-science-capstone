...
# Date: 02-Oct-2021
# Description: Prediction Algorithm Of Next Word
# GitHub: https://github.com/priyasdamodharan/Coursera-data-science-capstone
...
shinyUI(
    navbarPage("Next Word Predict",
               ...
               tabPanel("About",
                        ...
                        br(),
                        div("Prediction Algorithm Of Next Word is a Shiny app that uses a text
                            ...
                            br(),
                            br(),
                            img(src = "/Users/priyadamodharan/desktop/Data-Science-Capstone-master/presentation/CapstoneApp.PNG"),
                            a(target = "_blank", href = "https://github.com/priyasdamodharan/Coursera-data-science-capstone",
                            "Prediction Algorithm Of Next Word"))
